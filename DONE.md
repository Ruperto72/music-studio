...
Vad som *är* byggt, och — viktigare — varför det ser ut som det gör.

Det här är avlastningen från `TODO.md`: när en punkt blir klar flyttas den
hit istället för att ligga kvar som en `[x]` i en lista över vad som
återstår. `TODO.md` handlar om vad som saknas; det här dokumentet är
arbetsjournalen.

Posterna är inte en changelog. De är korta men fylliga med avsikt: de bär
**mätningarna** (nivåer i dB, nodräkningar, sampeljämförelser), **vad som
uteslöts och hur**, och **varför en lösning ser ut som den gör snarare än
som det uppenbara alternativet**. Flera av dem dokumenterar också misstag
— påståenden jag skrev innan jag hade beviset — eftersom det är den delen
som är dyrast att upptäcka två gånger. `DESIGN.md` beskriver hur appen
fungerar i dag; det här beskriver hur den kom dit.

Ordningen är den `TODO.md` hade, inte kronologisk.
...
vågform. Det är avsiktligt: de hör hemma på kanalen, inte på en ton — och
med pan per not på plats är asymmetrierna i den här listan slut.
